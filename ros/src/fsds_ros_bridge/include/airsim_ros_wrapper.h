...
#include <fs_msgs/Custom.h>
#include <fs_msgs/CustomPoint.h>
#include <chrono>
...
private:
    ...
    fs_msgs::Custom get_lidar_msg_from_airsim_custom(const std::string &lidar_name, const msr::airlib::LidarData& lidar_data) const;
